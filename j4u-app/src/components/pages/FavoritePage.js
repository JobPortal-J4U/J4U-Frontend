              ...
              <div class="job-item p-4 mb-4">
                <div class="row g-4">
                  <div class="col-sm-12 col-md-8 d-flex align-items-center">
                    ...
                    <div class="text-start ps-4 text-dark" key={jobPost.id}>
                  ...
                  <div class="col-sm-12 col-md-4 d-flex flex-column text-dark align-items-start align-items-md-end justify-content-center">
