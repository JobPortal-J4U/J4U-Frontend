...
import { addNewEducation } from "./eduSlice";
  ...
  const onSaveEduClicked = () => {
    if (canSave) {
      try {
        ...
        dispatch(addNewEducation({ highSchoolName,degreeName,startDate,endDate })).unwrap();
        ...
        console.error("Failed to save the Education", err);
      } finally {
                  ...
                  <div class="container shadow-lg border-0 rounded-lg  p-3 CompanyForm">
                    <div class="card-header  ">
                      ...
                      <div class="d-flex flex-column  ">
                        <h3 class="text-center">EDU Form</h3>
                        <img
                      ...
                      <form>
                        <div class="row">
                          <div class=" mb-3 col-md-6 h-100 ">
                            <label for="title">High School*</label>
                            <input
                              class="form-control"
                              id="highschool"
                              type="text"
