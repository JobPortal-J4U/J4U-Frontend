...
import { addNewPersonalInfo } from "./personalinfoSlice";
...
const PersonalInfoForm = () => {
  ...
  const canSave =
    [name, nrc, dateOfBirth, address, city, country, phone, race, gender].every(
      Boolean
  ...
  const onSavePersonalClicked = () => {
    if (canSave) {
      try {
        ...
        console.error("Failed to save the Info", err);
      } finally {
          ...
          <main className="justify-content-center ">
            <div class="container pt-2">
              <div class="row ">
                ...
                <div class="col-lg-8">
                  <div class="container shadow-lg border-0 rounded-lg  p-3 InfoForm">
