    ...
    <>
      <div className="container ">
        ...
        <div class="header-wrapper">
          <header></header>
          <div class="cols-container bg-light">
            <div class="left-col">
              <div class="img-container">
                <img
                  src="https://i.pinimg.com/236x/f7/3e/fe/f73efee3900f890a2239725468da9f9d.jpg"
                  alt=""
                ></img>
              </div>
              <h3 class="mb-3" style={{ marginLeft: "30px" }}>
                {loginUser.fullname}
              </h3>
        ...
        {/* About */}
        <div class="container about bg-light" id="about">
        ...
        {/* Education */}
        <div class="education bg-light" id="education">
        ...
        {/* Experience */}
        <div class="experience bg-light" id="experience">
          <div class="content-inner">
            <div class="content-header">
              <h2>Experience</h2>
            </div>
